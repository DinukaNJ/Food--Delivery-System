       ...
       <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Options Table</a>
          </div>
...
%>
   ...
   List<option> optionList = (ArrayList<option>) request.getAttribute("optionList");
                       for(option it : optionList){
                            
            %> 
                          
                 <form   action="${pageContext.request.contextPath}/EditOption" method="POST"   >         
                        <tr>
                          <td>
...
<!--                          <input type="text" value="<%= it.getOptions()%>" name="fddes"/> -->
                          
                          
                          
                          <select class="form-control" id="fdtype" name="fdoption">
                             
                         <option value="<%= it.getOptions()%>"><%= it.getOptions()%></option>
                          <option value="Egg">Egg</option>
                          <option value="chicken">chicken</option>
                          <option value="vegetable">vegetable</option>
                          <option value="fish">fish</option>
                         ...
                         <option value="Short Eats">Short Eats</option>
                          ...
                          <td>
                           ...
                           <td class="td-actions text-right">
                              ...
                              <a href="DeleteOptions?id=<%= it.getId()%>">
